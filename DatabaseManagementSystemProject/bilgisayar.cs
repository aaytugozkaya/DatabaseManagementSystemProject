...
namespace DatabaseManagementSystemProject
{
    public partial class bilgisayar : Form
    {
        ...
        {
            baglan.Open();
            NpgsqlCommand ekleme = new NpgsqlCommand("insert into public.bilgisayar (anakart,ram1,ram2,islemci,monitorpanel,ekranKarti,klavye,hdd,ssd) values (@p1,@p2,@p3,@p4,@p5,@p6,@p7,@p8,@p9) ", baglan);
